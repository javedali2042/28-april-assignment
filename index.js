...
function wordsWithFunc(wordsString) {
...
// Question no 12
let fruits = ["Apple", "Banana", "Orange", "Avacado", "Mango"];
...
// Question no 19
let checkElement = [1, 2, 3, "a", "b", "c", true];
let findEle1 = 'a';
let findEle2 = 5;
...
function minMaxAverage(numbers) {
    ...
    let average = numbers.reduce((sum, current) => sum + current, 0) / numbers.length;
...
function logUncompletedTasks(todoList) {
    todoList
